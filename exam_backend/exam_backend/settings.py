...
SECRET_KEY = "django-insecure-qn8ktt_=((b@&p_^u-slc)-#vys&w5xf3=5qctd7n$(y*pj=62"
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:5173",  # ✅ Allow only this frontend to access the API
    "http://127.0.0.1:5173",
]
